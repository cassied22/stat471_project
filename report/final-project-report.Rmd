...
```
The correlation between different features are shown in Figure \@ref(fig:covariance).

```{r covariance, out.width = "80%", fig.cap = 'Correlation Maxtrix', fig.pos = "H", fig.align = "center",echo = FALSE}
knitr::include_graphics("../results/covariance.png")
```
